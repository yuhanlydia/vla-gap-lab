...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="official closed-loop shift SR / clean SR; omit for probe-only diagnostics",
    )
    ...
    gate = None
    if args.control_retention is not None:
    ...
    print(json.dumps({"gate": gate, "output": str(args.output)}, indent=2))
